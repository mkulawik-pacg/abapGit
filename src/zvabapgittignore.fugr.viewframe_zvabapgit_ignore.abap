*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVABAPGIT_IGNORE
*   generation date: 15.09.2019 at 20:59:08
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVABAPGIT_IGNORE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVABAPGIT_IGNORE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVABAPGIT_IGNORE_EXTRACT
TOTAL = ZVABAPGIT_IGNORE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVABAPGIT_IGNORE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVABAPGIT_IGNORE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVABAPGIT_IGNORE_EXTRACT
TOTAL = ZVABAPGIT_IGNORE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVABAPGIT_IGNORE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVABAPGIT_IGNORE'
...
TOTAL = ZVABAPGIT_IGNORE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVABAPGIT_IGNORE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVABAPGIT_IGNORE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVABAPGIT_IGNORE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVABAPGIT_IGNORE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVABAPGIT_IGNORE_EXTRACT
TOTAL = ZVABAPGIT_IGNORE_TOTAL
